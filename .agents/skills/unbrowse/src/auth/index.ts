...
import { storeCredential, getCredential } from "../vault/index";
import { nanoid } from "nanoid";
import { isDomainMatch, getRegistrableDomain } from "../domain";
...
export async function extractBrowserAuth(
  ...
  const { extractBrowserCookies } = await import("./browser-cookies");
